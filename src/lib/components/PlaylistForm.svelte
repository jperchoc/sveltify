...
<form method="POST" {action} use:enhance={() => {
    ...
    <div class="field" class:has-error={form?.nameError}>
        ...
        <input type="text" id="playlist-name" name="name" placeholder="Playlist Name" value={form?.name || playlist?.name || ''} />
        {#if form?.nameError}
    ...
    <div class="field">
        ...
        <input type="text" id="playlist-description" name="description" placeholder="Playlist Description" value={form?.description || playlist?.description ||''} />
    </div>
    {#if form?.apiError}
    ...
    <div class="submit-button">
        <Button element="button" type="submit" disabled={isLoading}>{playlist ? 'Save' : 'Create'} Playlist</Button>
    </div>
</form>
